...
/**
 * OrderSearch represents the model behind the search form about `supplier\models\Order`.
 */
class OrderSearch extends Order
{
    ...
    {
        return [
            [['id', 'uid', 'order_status', 'pay_status', 'type', 'created_at', 'updated_at', 'order_service', 'over_at', 'start_at', 'brand_id'], 'integer'],
