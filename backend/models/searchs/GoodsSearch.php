...
class GoodsSearch extends Goods
{
    ...
    {
        return [
            [['id', 'image_id', 'attri_id', 'created_at', 'updated_at', 'is_del'], 'integer'],
            [['service_name', 'detail', 'type_id', 'status', 'service_cid'], 'safe'],
        ];
    }
    ...
    {
        $query = Goods::find()->where(['is_del' => self::DELETE_FALSE]);
