                                ...
                                <tr>
                                    <td>
                                        <?php foreach($nodeList as $node): ?>
                                            <dl>
                                                <dt>
                                                    <label class="checkbox-inline"><input class="rules_all" type="checkbox"><?= $node['name'] ?></label>
                                                </dt>
                                                <dd>
                                                ...
                                                <span class="child_row">
                                                    <?php foreach ($node['child'] as $child): ?>
                                                        <label class="checkbox-inline"><input class="auth_rules" type="checkbox" name="rules[]" value="<?= $child['route'] ?>" <?= array_key_exists($child['route'], $permission) ? "checked" : ""; ?>/><?= $child['name'] ?></label>
                                                    <?php endforeach; ?>
                                                </span>
                                                    </div>
                                                </dd>
