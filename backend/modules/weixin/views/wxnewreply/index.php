    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><a href="<?= Url::toRoute(['wxnewreply/create']) ?>">
                        <button type="button" class="btn bg-purple">新增文本回复</button>
                    </a></h3>
            </div>
            <div class="box-body">
                ...
                <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php foreach ($data as $val) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= Url::toRoute(['/weixin/wxnewreply/update', 'id' => $val->id]) ?>">
...
menuheight('weixin-wxnewreply-index');
JS;
