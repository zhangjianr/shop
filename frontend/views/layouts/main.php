    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-weixin text-green"></i> <span>客户端</span> <i class="fa fa-angle-left pull-right"></i>
                        <ul class="treeview-menu">
                            <li><a href="<?= Url::toRoute(['/person/update','id'=>Yii::$app->user->identity->id])?>"><i class="fa fa-search-plus text-aqua"></i> 修改个人资料</a></li>
